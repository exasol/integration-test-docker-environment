...
def pytest_addoption(parser):
    ...
    group.addoption(
        _option_name("schema"),
        type=str,
        help="Schema to open after connecting to the db (default: TEST).",
    )
    group.addoption(
        _option_name("bootstrap"),
        type=bool,
        help="Signals that pytest itself should start the exasol db rather than using an active one (default: False).",
    )
