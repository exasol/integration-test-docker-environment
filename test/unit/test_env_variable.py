...
def test_var_not_set_same_logging_file():
    """
...
def test_custom_log_path_points_at_file():
    """
...
def test_same_logging_file_custom_log_path():
    """
    Integration test which verifies that re-using the same logging for multiple tasks works as expected,
...
def test_different_custom_logging_file():
    """
...
def test_custom_log_path_points_at_dir():
    """
...
def test_missing_dir_in_custom_log_path():
    """
