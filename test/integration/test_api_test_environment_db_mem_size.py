...
def test_default_db_mem_size(api_context):
    with api_context() as db:
        _assert_mem_size(db.environment_info.database_info.container_info.container_name, "2 GiB")
...
def test_smallest_valid_db_mem_size(api_context):
    ...
    with api_context(additional_parameters=additional_parameters,) as db:
        _assert_mem_size(db.environment_info.database_info.container_info.container_name, "1 GiB")
