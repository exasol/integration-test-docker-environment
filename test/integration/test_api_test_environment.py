...
def test_environment_info_set(api_default_env_with_test_container):
    assert api_default_env_with_test_container.environment_info is not None


def test_all_containers_started(api_default_env_with_test_container):
    test_environment = api_default_env_with_test_container
...
def test_docker_available_in_test_container(
    api_default_env_with_test_container,
):
    environment_info = api_default_env_with_test_container.environment_info
...
def test_db_container_available(api_default_env_with_test_container):
    environment_info = api_default_env_with_test_container.environment_info
    with ContextDockerClient() as docker_client:
...
def test_db_available(api_default_env_with_test_container):
    test_environment = api_default_env_with_test_container
...
def test_build_mapping(api_default_env_with_test_container):
    environment_info = api_default_env_with_test_container.environment_info
    with ContextDockerClient() as docker_client:
        test_container = docker_client.containers.get(
            environment_info.test_container_info.container_name
