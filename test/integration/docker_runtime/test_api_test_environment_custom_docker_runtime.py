...
def test_test_container_runtime(environment_with_custom_docker_runtime, default_docker_runtime):
...
def test_database_container_runtime(environment_with_custom_docker_runtime, default_docker_runtime):
    environment_info = environment_with_custom_docker_runtime.environment_info
    database_container_name = (
        environment_info.database_info.container_info.container_name
    )
    assert_container_runtime(
        database_container_name, default_docker_runtime
    )
