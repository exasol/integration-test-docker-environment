...
from docker_db_starter_src.lib.utils.file_directory_list_hasher import FileDirectoryListHasher
from docker_db_starter_src.lib.data.image_info import ImageInfo, ImageDescription

# TODO add hash config to the hash
class BuildContextHasher:
    logger = logging.getLogger('luigi-interface')

    def __init__(self, task_id, image_description: ImageDescription):
