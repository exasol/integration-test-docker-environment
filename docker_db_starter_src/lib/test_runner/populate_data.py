...
# Imports data via exaplus to support batch imports.
# It assumes a import.sql at the path /tests/{path_to_data}/import.sql.
class PopulateDataToDatabase(StoppableTask):
    ...
    def populate_data(self):
        ...
        cmd = f"""cd /tests/{self.path_to_data}; $EXAPLUS -c '{self._database_info.host}:{self._database_info.db_port}' -u '{username}' -p '{password}' -f import.sql"""
