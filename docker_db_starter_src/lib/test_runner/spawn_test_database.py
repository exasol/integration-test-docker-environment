...
from docker_db_starter_src.lib.data.container_info import ContainerInfo
from docker_db_starter_src.lib.data.database_info import DatabaseInfo
from docker_db_starter_src.lib.data.dependency_collector.dependency_database_info_collector import DATABASE_INFO
from docker_db_starter_src.lib.data.docker_network_info import DockerNetworkInfo
from docker_db_starter_src.lib.data.image_info import ImageInfo
from docker_db_starter_src.lib.docker.pull_log_handler import PullLogHandler
from docker_db_starter_src.lib.docker_config import docker_client_config
from docker_db_starter_src.lib.still_running_logger import StillRunningLogger
...
class SpawnTestDockerDatabase(StoppableTask):
    ...
    def upload_init_db_files(self,
        ...
        with tarfile.open(fileobj=file_like_object, mode="x") as tar:
            tar.add("docker_db_starter_src/lib/test_runner/init_db.sh", "init_db.sh")
