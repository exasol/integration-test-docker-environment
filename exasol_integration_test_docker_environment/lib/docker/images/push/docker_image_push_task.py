...
from exasol_integration_test_docker_environment.lib.docker.images.push.docker_image_push_base_task import \
    DockerPushImageBaseTask
...
class DockerPushImageTask(DockerPushImageBaseTask):
    ...
    required_task_info : RequiredTaskInfo = JsonPickleParameter(RequiredTaskInfo,
