...
class GeneralSpawnTestEnvironmentParameter(OptionalTestContainerParameter):
    ...
    no_test_container_cleanup_after_success: bool = luigi.BoolParameter(False, significant=False)
    no_test_container_cleanup_after_failure: bool = luigi.BoolParameter(False, significant=False)
