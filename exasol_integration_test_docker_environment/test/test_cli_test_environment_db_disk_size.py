...
class DockerTestEnvironmentDBDiskSizeTest(unittest.TestCase):
    """
    Deprecated. Replaced by "./test/integration/test_api_test_environment_db_disk_size.py
    """
    ...
    def test_smallest_valid_db_disk_size(self):
        ...
        with self.test_environment.spawn_docker_test_environments(
            name=self.docker_environment_name,
            additional_parameter=["--db-disk-size", "'100 MiB'"],
        ):
    ...
    def test_invalid_db_mem_size(self):
        ...
        with self.assertRaises(Exception) as context:
            with self.test_environment.spawn_docker_test_environments(
                name=self.docker_environment_name,
                additional_parameter=["--db-disk-size", "'90 MiB'"],
            ):
                pass
