    ...
    def test_all_containers_started(self):
        with ContextDockerClient() as docker_client:
            ...
            self.assertEqual(len(containers), 2,
                             ...
                             f"{self.on_host_docker_environment.completed_process.stdout.decode('utf8')}")
    ...
    def test_docker_available_in_test_container(self):
        with ContextDockerClient() as docker_client:
            ...
            self.assertEqual(exit_code, 0,
                             ...
                             f"Startup log was: {self.on_host_docker_environment.completed_process.stdout.decode('utf8')}")
